...
CREATE TABLE user (
    ...
    passwordReset VARCHAR(32) NOT NULL,
    emailVerified BOOLEAN NOT NULL,
    emailVerifyCode VARCHAR(32) NOT NULL,
    signupSource VARCHAR(100) NOT NULL,
    UNIQUE(email),
    PRIMARY KEY(id)
) ENGINE = InnoDB;
...
CREATE TABLE token (
    id BINARY(16) NOT NULL,
    name VARCHAR(100),
    userOrgId INT UNSIGNED NOT NULL,
    PRIMARY KEY(id)
) ENGINE = InnoDB;
